...
export default function IndexPage() {
    ...
    <Layout>		
		<CookieConsent
			cookieName="simplysaypteltd"		
			containerClasses="col-lg-12"
			style={{ background: "#2B373B", opacity: "0.9" }}
		>
			Simply Say uses cookies to provide a better user experience. Please see our <Link to='/privacy'>privacy policy</Link> for more details. Thanks!
		</CookieConsent>	   			
		<Styles.FrontPageTitle><h1>{data.nodeFrontPage.title}</h1></Styles.FrontPageTitle>
		<div className="row">
